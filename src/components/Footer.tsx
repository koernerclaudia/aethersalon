    ...
    <footer className="bg-theme-50 border-t border-brass/30 py-12">
      <div className="mx-auto max-w-5xl px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
          ...
          <div className="flex flex-col items-center md:items-start md:pr-6">
            <img
              src="/Aethersalon.svg"
          ...
          {/* Right: two columns (navigation + legal/contact) */}
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li>
                <Link to="/contact" className="text-theme hover:text-brass transition-colors text-sm mb-4 block">
                  Kontaktformular
                </Link>
              </li>
            </ul>
