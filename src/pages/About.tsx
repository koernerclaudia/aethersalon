...
const About: React.FC = () => {
  return (
    // remove top padding so hero image can sit behind the fixed header (like Home)
    <div className="min-h-screen px-4 pb-20">
      {/* Hero */}
      <section className="relative h-[56vh] md:h-[48vh] flex items-center">
        {/* full-bleed background: make the background div stretch the full viewport width */}
        <div
        ...
        <div className="relative z-10 container mx-auto max-w-4xl text-center">
          ...
          >
            Tradition trifft Phantasie — wir fertigen mechanische, handgearbeitete Objekte mit Herz
            und Präzision. Lernen Sie das Team kennen und wo Sie uns live erleben können.
          </motion.p>
        </div>
      </section>
      ...
      <section className="container mx-auto max-w-5xl mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Link to="/history" className="block p-6 rounded-lg border border-brass/30 bg-theme-50 hover:shadow-lg transition-shadow">
            <h3 className="text-xl font-semibold text-theme mb-2">Steampunk</h3>
            <p className="text-theme-80">Geschichten, Inspirationen und die Welt hinter unserem Stil.</p>
          </Link>
        </div>
      </section>
    </div>
